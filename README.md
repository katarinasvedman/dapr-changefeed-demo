...
This is a rewrite of the to use Dapr in the demo for session "Cosmos DB as the event store hero for Serverless event-driven applications". This demo is based on the "Change Feed Lab" (https://azure.microsoft.com/en-us/resources/samples/azure-cosmos-db-change-feed-dotnet-retail-sample/). All instructions for the lab is added below.
